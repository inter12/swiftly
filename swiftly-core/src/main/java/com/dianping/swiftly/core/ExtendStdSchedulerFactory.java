 ...
 * </pre>
 */
public class ExtendStdSchedulerFactory extends StdSchedulerFactory {
    ...
    public static final String PROP_JOB_STORE_LOCK_HANDLER_PREFIX                                               = PROP_JOB_STORE_PREFIX
                                                                                                                  + ".lockHandler";

    public static final String PROP_JOB_STORE_LOCK_HANDLER_CLASS                                                = PROP_JOB_STORE_LOCK_HANDLER_PREFIX
                                                                                                                  + ".class";
    ...
    /**
     * @deprecated Replaced with {@link org.quartz.utils.PoolingConnectionProvider#DB_DRIVER}
     */
    @Deprecated
    public static final String PROP_DATASOURCE_DRIVER                                                           = "driver";

    /**
     * @deprecated Replaced with {@link org.quartz.utils.PoolingConnectionProvider#DB_URL}
     */
    @Deprecated
    public static final String PROP_DATASOURCE_URL                                                              = "URL";

    /**
     * @deprecated Replaced with {@link org.quartz.utils.PoolingConnectionProvider#DB_USER}
     */
    @Deprecated
    public static final String PROP_DATASOURCE_USER                                                             = "user";

    /**
     * @deprecated Replaced with {@link org.quartz.utils.PoolingConnectionProvider#DB_PASSWORD}
     */
    @Deprecated
    public static final String PROP_DATASOURCE_PASSWORD                                                         = "password";

    /**
     * @deprecated Replaced with {@link org.quartz.utils.PoolingConnectionProvider#DB_MAX_CONNECTIONS}
     */
    @Deprecated
    public static final String PROP_DATASOURCE_MAX_CONNECTIONS                                                  = "maxConnections";

    /**
     * @deprecated Replaced with {@link org.quartz.utils.PoolingConnectionProvider#DB_VALIDATION_QUERY}
     */
    @Deprecated
     ...
     */
    public ExtendStdSchedulerFactory() {
    }

    /**
     * Create a StdSchedulerFactory that has been initialized via <code>{@link #initialize(java.util.Properties)}</code>
     * .
     * 
     * @see #initialize(java.util.Properties)
     */
    public ExtendStdSchedulerFactory(Properties props) throws SchedulerException {
        initialize(props);
    }
     ...
     */
    public ExtendStdSchedulerFactory(String fileName) throws SchedulerException {
        initialize(fileName);
    }
    ...
    /**
     * <p>
     * Initialize the <code>{@link org.quartz.SchedulerFactory}</code> with the contents of a <code>Properties</code>
     * file and overriding System properties.
     * </p>
     * <p>
     * By default a properties file named "quartz.properties" is loaded from the 'current working directory'. If that
     * fails, then the "quartz.properties" file located (as a resource) in the org/quartz package is loaded. If you wish
     * to use a file other than these defaults, you must define the system property 'org.quartz.properties' to point to
     * the file you want.
     * </p>
     * <p>
     * System properties (environment variables, and -D definitions on the command-line when running the JVM) override
     * any properties in the loaded file. For this reason, you may want to use a different initialize() method if your
     * application security policy prohibits access to <code>{@link java.lang.System#getProperties()}</code>.
     * </p>
     */
            ...
            if (propFile.exists()) {
                try {
                    ...
                    initException = new SchedulerException(
                                                           "Properties file: '" + propFileName + "' could not be read.",
                                                           ioe);
                    throw initException;
                }
                ...
                if (in == null) {
                    initException = new SchedulerException("Properties file: '" + requestedFile
                                                           + "' could not be found.");
                    throw initException;
                }
                ...
                if (cl == null) throw new SchedulerConfigException(
    ...
    /**
     * Add all System properties to the given <code>props</code>. Will override any properties that already exist in the
     * given <code>props</code>.
     */
    ...
    /**
     * <p>
     * Initialize the <code>{@link org.quartz.SchedulerFactory}</code> with the contents of the <code>Properties</code>
     ...
     * <p>
     * Initialize the <code>{@link org.quartz.SchedulerFactory}</code> with the contents of the <code>Properties</code>
     * file opened with the given <code>InputStream</code>.
     * </p>
     */
    ...
    private Scheduler instantiate() throws SchedulerException {
        ...
        boolean interruptJobsOnShutdownWithWait = cfg.getBooleanProperty(PROP_SCHED_INTERRUPT_JOBS_ON_SHUTDOWN_WITH_WAIT,
                                                                         false);
        ...
        String rmiCreateRegistry = cfg.getStringProperty(PROP_SCHED_RMI_CREATE_REGISTRY,
        ...
        String managementRESTServiceHostAndPort = cfg.getStringProperty(MANAGEMENT_REST_SERVICE_HOST_PORT,
                                                                        "0.0.0.0:9889");
        ...
        if (jmxProxy) {
            ...
            try {
                ...
                initException = new SchedulerException("RemoteMBeanScheduler class '" + jmxProxyClass
        ...
        if (jobFactoryClass != null) {
            ...
            try {
                ...
                initException = new SchedulerException("JobFactory class '" + jobFactoryClass
                                                       + "' props could not be configured.", e);
                throw initException;
            }
        }
        ...
        if (instanceIdGeneratorClass != null) {
            try {
                ...
                throw new SchedulerConfigException(
                                                   "Unable to instantiate InstanceIdGenerator class: " + e.getMessage(),
                                                   e);
            }
            ...
            try {
                ...
                initException = new SchedulerException("InstanceIdGenerator class '" + instanceIdGeneratorClass
                                                       + "' props could not be configured.", e);
                throw initException;
            }
        }
        ...
        ExtendSchedulerDetailsSetter.setDetails(js, schedName, schedInstId);
        ...
        for (int i = 0; i < dsNames.length; i++) {
            PropertiesParser pp = new PropertiesParser(cfg.getPropertyGroup(PROP_DATASOURCE_PREFIX + "." + dsNames[i],
                                                                            true));
            ...
            if (cpClass != null) {
                ...
                if (dsJndi != null) {
                    ...
                    if (null != dsJndiInitial || null != dsJndiProvider || null != dsJndiPrincipal
        ...
        for (int i = 0; i < pluginNames.length; i++) {
            ...
            try {
                ...
                initException = new SchedulerException("SchedulerPlugin class '" + plugInClass
                                                       + "' could not be instantiated.", e);
                throw initException;
            }
            try {
                ...
                initException = new SchedulerException("JobStore SchedulerPlugin '" + plugInClass
                                                       + "' props could not be configured.", e);
                throw initException;
            }
        ...
        for (int i = 0; i < jobListenerNames.length; i++) {
            ...
            try {
                ...
                initException = new SchedulerException("JobListener class '" + listenerClass
                                                       + "' could not be instantiated.", e);
                throw initException;
            }
            try {
                ...
                initException = new SchedulerException("JobListener '" + listenerClass
                                                       + "' props could not be configured.", e);
                throw initException;
            }
        ...
        for (int i = 0; i < triggerListenerNames.length; i++) {
            ...
            try {
                ...
                initException = new SchedulerException("TriggerListener class '" + listenerClass
                                                       + "' could not be instantiated.", e);
                throw initException;
            }
            try {
                ...
                initException = new SchedulerException("TriggerListener '" + listenerClass
                                                       + "' props could not be configured.", e);
                throw initException;
            }
        ...
        if (threadExecutorClass != null) {
            ...
            try {
                ...
                initException = new SchedulerException("ThreadExecutor class '" + threadExecutorClass
                                                       + "' could not be instantiated.", e);
                throw initException;
            }
        } else {
        ...
        try {
            ...
            ExtendSchedulerDetailsSetter.setDetails(tp, schedName, schedInstId);
     ...
     * </p>
     * <p>
     * If one of the <code>initialize</code> methods has not be previously called, then the default (no-arg)
     * <code>initialize()</code> method will be called by this method.
     * </p>
     */
    ...
    public static Scheduler getDefaultScheduler() throws SchedulerException {
        ExtendStdSchedulerFactory fact = new ExtendStdSchedulerFactory();
